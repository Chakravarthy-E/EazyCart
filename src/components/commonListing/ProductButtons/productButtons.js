...
export default function ProductButton({ item }) {
  ...
  return isAdminView ? (
    <>
      <button
        className=" mt-1.5 w-full text-white hover:text-blue-500  dark:bg-white dark:text-black flex justify-center bg-black px-5 py-3 text-xs font-semibold  uppercase tracking-wide rounded"
        onClick={() => {
      ...
      <button
        className=" mt-1.5 w-full text-white hover:text-blue-500  font-semibold  dark:bg-white dark:text-black flex justify-center bg-black px-5  py-3 text-xs uppercase tracking-wide rounded"
    ...
    <>
      <button
        className=" mt-1.5 w-full  text-white flex hover:text-blue-500  dark:bg-white dark:text-black font-semibold  items-center justify-center bg-black px-5 py-3 text-xs  uppercase tracking-wide  rounded"
